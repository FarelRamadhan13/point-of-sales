<section class="py-10 px-[8rem]">
    <div class="bg-gray-900 rounded-lg p-4">
        <form action="<?= action('/master/admin/create') ?>" method="post" class="flex flex-col text-gray-400 gap-[1rem]">

            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-bold text-gray-200">Add Admin</h1>
            ...
            <div class="flex flex-col gap-2 text-white">
                ...
                <input type="password" required name="password" id="password" placeholder="Password" class="p-2 bg-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
            </div>
